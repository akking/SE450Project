...
public class SwingAnimatorBuilder implements AnimatorBuilder {
    ...
    public Animator getAnimator() {
        ...
        Animator returnValue = new SwingAnimator(painter, "Traffic Simulator", VP.displayWidth, VP.displayHeight, VP.displayDelay);
        painter = null;
        return returnValue;
    }
    ...
    private static class MyPainter implements SwingAnimatorPainter {
        ...
        public void paint(Graphics g) {
            ...
            for (Element<Light> e : lightElements) {
                if (e.x.getState() == MP.GREENNS_REDEW) {
                    g.setColor(Color.RED);
                } else if (e.x.getState() == MP.REDNS_GREENEW) {
                    g.setColor(Color.GREEN);
                } else if (e.x.getState() == MP.YELLOWNS_REDEW) {
                    g.setColor(Color.RED);
                } else {
